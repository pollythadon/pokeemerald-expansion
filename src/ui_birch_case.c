...
//
//wanted to retool as hate organization of this
//but too much effort,
//added starterId field to struct
//to properly allign with default setup
...
static const struct MonChoiceData sStarterChoices[9] =
{
    ...
    [BALL_TOP_THIRD]        = {SPECIES_TURTWIG, 5, GRASS_STARTER},
    [BALL_TOP_FOURTH]       = {SPECIES_PIPLUP, 5, WATER_STARTER},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CHIMCHAR, 5, FIRE_STARTER},

    [BALL_MIDDLE_SECOND]    = {SPECIES_LARVITAR, 5, GRASS_STARTER},
    [BALL_BOTTOM_FIRST]     = {SPECIES_DRATINI, 5, FIRE_STARTER},
    [BALL_BOTTOM_SECOND]    = {SPECIES_RIOLU, 5, WATER_STARTER},
};
