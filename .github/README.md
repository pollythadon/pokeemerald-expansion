...
This is the first iteration of my feature branch that adds a sprite based start menu similar to Pokémon Unbound. This is still in alpha and needs a lot of testing.

## Credits

Find the credits for expansion [here](https://github.com/rh-hideout/pokeemerald-expansion/blob/master/CREDITS.md)

- hedara (`even_sprite` functions)
- vol (icons)
