...
#define FLAG_DIALGA_DFTD     0x31 // Unused Flag
#define FLAG_PALKIA_DFTD     0x32 // Unused Flag
#define FLAG_DARKRAI_DFTD    0x33 // Unused Flag
...
#define FLAG_MEWTWO_DFTD     0x38 // Mewtwo Defeated Flag. Set when Mewtwo is defeated, so it doesn't reappear after the player leaves the area.
#define FLAG_MEWTWO_BATTLE   0x39 // Mewtwo Sprite hide flag; cleared to make Mewtwo appear.
...
#define FLAG_EXP_SHARE                       0x68  // EXP Share whole team
...
#define FLAG_HIDE_ROAMING_LEGEND_QUEST_GIVERS 0x1DE
...
#define FLAG_STARTED_MEGA_RING_QUEST                                0x493
